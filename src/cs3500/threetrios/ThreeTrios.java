...
import cs3500.threetrios.model.PlayerColor;  // Add this import
...
/**
 * A class for running the Three Trios game.
 */
public final class ThreeTrios {

  /**
   * Runs a game of three trios.
   *
   * @param args takes in 4 arguments defining, map, deck, redPlayer, bluePlayer
   */
  public static void main(String[] args) {
    SwingUtilities.invokeLater(() -> {
      try {
        ...
        ThreeTriosGUI redView = new ThreeTriosGUI(model, PlayerColor.RED);    // Add PlayerColor.RED
        ThreeTriosGUI blueView = new ThreeTriosGUI(model, PlayerColor.BLUE);  // Add PlayerColor.BLUE
